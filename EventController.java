...
public class EventController{
    ...
    public ResponseEntity<CreateEventResponseDto> createEvent(
        ...
        @Valid @RequestBody CreateEventRequestDto createEventRequestDto){
            ...
            //eventMapper.fromDto(createEvenetRequestDto);
    ...
    public ResponseEntity<UpdateEventResponseDto> updateEvent(
        ...
        @Valid @RequestBody UpdateEventRequestDto updateEventRequestDto){
            ...
            updateEventRequest.setId(eventId);
            System.out.println(eventId);
            UUID userId=parseUserId(jwt);
        ...
        @AuthenticationPrincipal Jwt jwt,Pageable pageable)
        {
          ...
          Page<Event> events=eventService.listEventsForOrganizer(userId, pageable);
           return ResponseEntity.ok(
            events.map(event -> eventMapper.toListEventResponseDto(event))
        );
    ...
    public ResponseEntity<List<CreateEventResponseDto>> getAllEvents() {
        ...
        List<CreateEventResponseDto> eventDtos = events.stream()
